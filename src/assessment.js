...
function context1(myFn, context, param1, param2) {
  context.prototype.myFn = function(param1, param2) {

  }
  return context.myFn(param1, param2);
}
...
function context2(myFn, context, params) {
  ...
  context.prototype.myFn = function(params) {

  };
  return context.myFn(params);
};
...
function context3(myFn, context) {
  context.prototype.myFn = function() {
...
function sentenceMachine(partOne){
  var sentenceSmasher = function(partOne, partTwo) {
    var newString = this.partOne.toString() + this.partTwo.toString();
    return newString;
  }
...
function subway(personName) {
  var addIngredient = function(ingredient, ingredients) {
